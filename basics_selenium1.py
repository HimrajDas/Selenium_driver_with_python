...
driver = webdriver.Chrome(service=Service("chromedriver.exe"))    # to use the functionality of the web driver we need to create the object of the drive with specific browser which we want to use
